...
export const RT: Record<ReportLang, Record<string, string>> = {
  en: {
    ...
    ownerFlagHeader: "FLAGGED BY OWNER",
    ownerFlagNote: "Looked at and passed through exactly as the foreman submitted.",
    shortPayHeader: "SHORT PAY — ADDED HOURS",
    shortPayNote: "Hours missed on an earlier card. Add these to this week's checks.",
    shortPayTotal: "Short pay total",
    shortPayWorked: "worked",
  ...
  es: {
    ...
    ownerFlagHeader: "MARCADO POR EL DUEÑO",
    ownerFlagNote: "Revisado y aceptado tal como lo entregó el foreman.",
    shortPayHeader: "PAGO FALTANTE — HORAS AGREGADAS",
    shortPayNote: "Horas que faltaron en una tarjeta anterior. Agrégalas a los cheques de esta semana.",
    shortPayTotal: "Total de pago faltante",
    shortPayWorked: "trabajado",
